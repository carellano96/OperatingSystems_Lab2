public class Process {
    ...
    public void randomBurstTime() {
        ...
        this.CPUBurstTime = RandomOS.getRandomNumber(this.B);
        //System.out.println(CPUBurstTime);
    }
    public void randomBurstRR(){
        this.CPUBurstTime=RandomOS.getRandomNumber(2);
    }

    public void randomIO() {
        //System.out.println("");
        //System.out.print("Find I/O burst when blocking a process ");
        this.IOBurstTime = RandomOS.getRandomNumber(this.IO);
